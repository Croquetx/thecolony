/*  #define IBM_MakeRobot  /*	*/
/*  #define IBM_SetObject  /*  */
/*  #define IBM_InitRobot  /*  */
/*  #define IBM_SetRobot   /*  */

/*  #define IBM_InitObject /*	  */
/*  #define IBM_NewObject  /*	  */
/*  #define IBM_CreateObject /*   */
/*			 */

/*  #define IBM_SaveLevel   */
...
while(--i >= 0)
	...
	if(Object[n].alive)
		{
		nearClipRect= Object[n].clip;
		ClipRect(&nearClipRect);

		/*  ClipRect(&Object[n].clip);	*/
		Object[n].where.xmn=screenR.right;
		Object[n].where.xmx=screenR.left;
		...
		if(Object[n].type<=UPYRAMID ||
			(Object[n].type>=QUEEN&&Object[n].type<=SOLDIER))
		if(Object[n].where.xmn<centerX && Object[n].where.xmx>centerX)
			insight=TRUE;
		}
	}
#endif
...
int l,r,num;
{
#if !defined(IBM_SetRobot)
if(l<screenR.left)l=screenR.left;
if(r>screenR.right)r=screenR.right;
if(l>=r)return;
Object[num].visible=TRUE;
Object[num].clip.left  = l+1;
Object[num].clip.right = r-2;
