/*  #define IBM_GoToMap      */
/*  #define IBM_OpenDoor     */
/*  #define IBM_OpenElevator */
/*  #define IBM_OpenAirLock  */
/*  #define IBM_UpStairs     */
/*  #define IBM_DownStairs   */
/*  #define IBM_GoTo	     */
/*  #define IBM_DoUpStairs   */
/*  #define IBM_DoDnStairs   */
/*                       */
/*----------------------------------*
 * The Colony
 ...
 *----------------------------------------------------------------------*
 ...
 Note from Randy:
    ...
    (*map.data)  is in far memory so all pointers to it must be far
...
DoUpStairs()
{
#if !defined(IBM_DoUpStairs)
#endif
}
/*----------------------------------------------------------------------*/
DoDnStairs()
{
#if !defined(IBM_DoDnStairs)
