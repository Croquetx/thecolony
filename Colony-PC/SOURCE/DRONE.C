/*  #define IBM_MakeDrone    */
/*  #define IBM_MakeSoldier  */
/*                       */
/*----------------------------------*
 * The Colony
...
switch(body)
	...
	case 0:
		...
		if(faraway>=0){draweyes(num);draweyes(num);}
