...
typedef unsigned char Surf3D[SURFSIZE];	
...
typedef struct{
	...
	unsigned char surfaces;	/*number of surfaces				*/
	Surf3D *surface;/*[0][0]number of points			*/
					...
					/*.....								*/
	unsigned char *vsurface;	/*array of visible surface flags	*/
